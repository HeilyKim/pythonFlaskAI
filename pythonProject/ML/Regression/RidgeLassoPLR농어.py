...
#Ridge, Lasso : solving overfitting and underfitting problem
from sklearn.preprocessing import StandardScaler #릿지 쓰려면 스케일링을 해줘야됨
...
from sklearn.linear_model import Ridge #L1 규제 (정규화)[add penalty=sqr coef]
...
from sklearn.linear_model import Lasso  #L2 규제 (정규화) [add penalty to cost function]
